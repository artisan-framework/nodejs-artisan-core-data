...
import IDisposable from 'artisan-core/lib/IDisposable';
...
interface ISqlCommand extends IDisposable {
     ...
     */
    addInDictionaryParameter(name: string, value: KeyValuePair<any, any>[], keyType: string, keyOption: any, valueType: string, valueOption: any): void;
